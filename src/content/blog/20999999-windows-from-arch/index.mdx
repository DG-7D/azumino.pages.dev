...
description: "Linux上からWindows環境を起動することなくWindowsをインストールしてみた話。"
---

以前VAIO Pro 13にArch Linuxをインストールした。続けてWindowsもインストールし直すが、ただインストールするのでは面白くないので、Windowsのインストール環境や回復環境を起動することなく、Linux上からWindowsをインストールしてみた。
