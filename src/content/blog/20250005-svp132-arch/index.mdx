...
```bash
reflector --save /etc/pacman.d/mirrorlist -c jp -l 5 # ミラー設定 (インストール後の環境に引き継がれる)
pacstrap -K /mnt base linux linux-firmware intel-ucode networkmanager iwd ms-edit sudo # お好きなように
```
